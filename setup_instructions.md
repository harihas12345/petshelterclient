...
1. Open the preview in the browser to view the React frontend application. Copy the preview URL of the running application. You will need it for future steps.

1. In the **.env** file, update the **VITE_REDIRECT_URI** variable using the preview URL copied in the previous step.
    
    <i aria-hidden="true" class="fas fa-sticky-note" style="color:#563377"></i> **Note:** Make sure that there are no trailing forward slashes (/) after the URL.
